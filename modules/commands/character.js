    ...
    var out = (msg) => api.sendMessage(msg, event.threadID,event.messageID);
        var axios = require('axios');
            ...
            //  2 dòng trên của bên penguin api nên kemenos đi , vô trang https://superheroapi.com/index.html để lấy key
                var key = '';
            var url = `https://www.superheroapi.com/api.php/${447735860291014}/search/${encodeURIComponent(name)}`;
        try {
...
module.exports.run = async function({ api, event, Users, Currencies, client,args }) {
