module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "HDGN",
  description: "tạo shortvideo",
  commandCategory: "system",
  usages: "shortvideo a => link",
  cooldowns: 5,
  dependencies: {
        "fs-extra": ""
    }
      ...
      if (getThread.some(item => item.in == event.body)) {
        ...
        if (typeof shortOut == "string") {
          ...
          if (shortOut.indexOf(" | ") !== -1) {
            ...
            fs.writeFileSync( __dirname + `/cache/shortvideo${i}.mp4`, Buffer.from(shortvideo, "utf-8"));
            ...
            fs.writeFileSync( __dirname + `/cache/shortvideo.mp4`, Buffer.from(shortvideo, "utf-8"));
            api.sendMessage({attachment: fs.createReadStream( __dirname + `/cache/shortvideo.mp4`)}, event.threadID, () => fs.unlinkSync(__dirname + `/cache/shortvideo.mp4`));             }
        }
