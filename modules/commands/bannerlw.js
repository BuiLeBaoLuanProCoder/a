...
return request(encodeURI(`https://api-ttk.herokuapp.com/banner/crossfire?text=${namee}`)).pipe(fs.createWriteStream(__dirname+'/cache/bannerwe.jpg')).on('close',() => callback());     
}