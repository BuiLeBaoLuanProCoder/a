...
process
    .on('unhandledRejection', (reason) => {
        console.log(reason);
       console.log('Well, looks like there is an unhandled rejection, see above for more details.');
    })
    .on('uncaughtException', err => {
        console.log(err);
        console.log('Uncaught Exception thrown, see above for more details.');
    });
      ...
      function () {
        ...
        for (const command of listCommand) {
          try {
            ...
            logger.loader(`[ WARN ] - Không Thể Load MODULE  vơi lỗi ${error}`);
          };
        }
      }(),
      function () {
